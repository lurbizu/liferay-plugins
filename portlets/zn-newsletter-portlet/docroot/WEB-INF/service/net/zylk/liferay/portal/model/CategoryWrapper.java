...
public class CategoryWrapper implements Category, ModelWrapper<Category> {
	...
	*/
	...
	@Override
	public int compareTo(net.zylk.liferay.portal.model.Category category) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<net.zylk.liferay.portal.model.Category> toCacheModel() {
		return _category.toCacheModel();
	}

	@Override
	public net.zylk.liferay.portal.model.Category toEscapedModel() {
		return new CategoryWrapper(_category.toEscapedModel());
	}

	@Override
	public net.zylk.liferay.portal.model.Category toUnescapedModel() {
