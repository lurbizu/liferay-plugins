...
public class MailingSubscriptorWrapper implements MailingSubscriptor,
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<net.zylk.liferay.portal.model.MailingSubscriptor> toCacheModel() {
		return _mailingSubscriptor.toCacheModel();
	}

	@Override
	public net.zylk.liferay.portal.model.MailingSubscriptor toEscapedModel() {
		return new MailingSubscriptorWrapper(_mailingSubscriptor.toEscapedModel());
	}

	@Override
	public net.zylk.liferay.portal.model.MailingSubscriptor toUnescapedModel() {
