...
public class NewsletterWrapper implements Newsletter, ModelWrapper<Newsletter> {
	...
	*/
	...
	@Override
	public int compareTo(net.zylk.liferay.portal.model.Newsletter newsletter) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<net.zylk.liferay.portal.model.Newsletter> toCacheModel() {
		return _newsletter.toCacheModel();
	}

	@Override
	public net.zylk.liferay.portal.model.Newsletter toEscapedModel() {
		return new NewsletterWrapper(_newsletter.toEscapedModel());
	}

	@Override
	public net.zylk.liferay.portal.model.Newsletter toUnescapedModel() {
