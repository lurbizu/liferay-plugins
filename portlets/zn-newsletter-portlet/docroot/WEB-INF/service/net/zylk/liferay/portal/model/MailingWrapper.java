...
public class MailingWrapper implements Mailing, ModelWrapper<Mailing> {
	...
	*/
	...
	@Override
	public int compareTo(net.zylk.liferay.portal.model.Mailing mailing) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<net.zylk.liferay.portal.model.Mailing> toCacheModel() {
		return _mailing.toCacheModel();
	}

	@Override
	public net.zylk.liferay.portal.model.Mailing toEscapedModel() {
		return new MailingWrapper(_mailing.toEscapedModel());
	}

	@Override
	public net.zylk.liferay.portal.model.Mailing toUnescapedModel() {
