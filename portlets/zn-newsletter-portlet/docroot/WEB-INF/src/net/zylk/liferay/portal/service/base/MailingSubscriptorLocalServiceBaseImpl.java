...
import net.zylk.liferay.portal.service.MailingSubscriptorLocalService;
...
/**
 * Provides the base implementation for the mailing subscriptor local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.zylk.liferay.portal.service.impl.MailingSubscriptorLocalServiceImpl}.
 * </p>
 *
 * @author zylk.net
 * @see net.zylk.liferay.portal.service.impl.MailingSubscriptorLocalServiceImpl
 * @see net.zylk.liferay.portal.service.MailingSubscriptorLocalServiceUtil
 * @generated
 */
public abstract class MailingSubscriptorLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MailingSubscriptorLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.zylk.liferay.portal.service.MailingSubscriptorLocalServiceUtil} to access the mailing subscriptor local service.
	 */
	...
	@Override
	public MailingSubscriptor addMailingSubscriptor(
		MailingSubscriptor mailingSubscriptor) throws SystemException {
		mailingSubscriptor.setNew(true);

		return mailingSubscriptorPersistence.update(mailingSubscriptor);
	}
	 ...
	 */
	@Override
	public MailingSubscriptor createMailingSubscriptor(
		long mailingSubscriptorId) {
		return mailingSubscriptorPersistence.create(mailingSubscriptorId);
	}
	...
	@Override
	public MailingSubscriptor deleteMailingSubscriptor(
		long mailingSubscriptorId) throws PortalException, SystemException {
		return mailingSubscriptorPersistence.remove(mailingSubscriptorId);
	}
	...
	public MailingSubscriptor deleteMailingSubscriptor(
		MailingSubscriptor mailingSubscriptor) throws SystemException {
		return mailingSubscriptorPersistence.remove(mailingSubscriptor);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MailingSubscriptor.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return mailingSubscriptorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return mailingSubscriptorPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MailingSubscriptor fetchMailingSubscriptor(long mailingSubscriptorId)
		throws SystemException {
		return mailingSubscriptorPersistence.fetchByPrimaryKey(mailingSubscriptorId);
	}
	 ...
	 */
	@Override
	public MailingSubscriptor getMailingSubscriptor(long mailingSubscriptorId)
		throws PortalException, SystemException {
		return mailingSubscriptorPersistence.findByPrimaryKey(mailingSubscriptorId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return mailingSubscriptorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MailingSubscriptor> getMailingSubscriptors(int start, int end)
		throws SystemException {
		return mailingSubscriptorPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getMailingSubscriptorsCount() throws SystemException {
		return mailingSubscriptorPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MailingSubscriptor updateMailingSubscriptor(
		MailingSubscriptor mailingSubscriptor) throws SystemException {
		return mailingSubscriptorPersistence.update(mailingSubscriptor);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("net.zylk.liferay.portal.model.MailingSubscriptor",
			mailingSubscriptorLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = mailingSubscriptorPersistence.getDataSource();
	...
	private MailingSubscriptorLocalServiceClpInvoker _clpInvoker = new MailingSubscriptorLocalServiceClpInvoker();
}