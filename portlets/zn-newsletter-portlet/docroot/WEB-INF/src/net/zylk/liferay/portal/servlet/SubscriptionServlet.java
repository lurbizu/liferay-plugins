 ...
 * url de jemeplo:
 * 
 * /delegate/subscription?ticketKey=2323w23
 *
 */
public class SubscriptionServlet extends HttpServlet {
	...
	private static Log _log = LogFactoryUtil.getLog(SubscriptionServlet.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {			
			_log.info("pasando por el subscription Servlet");
			...
			try {
				...
				// no se valida si el ticket esta expirado porque se va a hacer despues en el portlet
				if (ticket != null) {
...
//			url += layoutUrl;
			...
			url += "_" + CoreConstants.PORTLET_ID_SUBSCRIPTION + "_ticketKey=" + ticketKey;
