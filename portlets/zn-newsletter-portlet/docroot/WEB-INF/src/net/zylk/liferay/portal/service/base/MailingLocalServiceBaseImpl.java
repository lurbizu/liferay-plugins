...
import net.zylk.liferay.portal.service.MailingLocalService;
...
/**
 * Provides the base implementation for the mailing local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.zylk.liferay.portal.service.impl.MailingLocalServiceImpl}.
 * </p>
 *
 * @author zylk.net
 ...
 * @generated
 */
public abstract class MailingLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements MailingLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.zylk.liferay.portal.service.MailingLocalServiceUtil} to access the mailing local service.
	 */
	...
	@Override
	public Mailing addMailing(Mailing mailing) throws SystemException {
		mailing.setNew(true);

		return mailingPersistence.update(mailing);
	}
	 ...
	 */
	@Override
	public Mailing createMailing(long mailingId) {
		return mailingPersistence.create(mailingId);
	}
	...
	@Override
	public Mailing deleteMailing(long mailingId)
		throws PortalException, SystemException {
		return mailingPersistence.remove(mailingId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Mailing deleteMailing(Mailing mailing) throws SystemException {
		return mailingPersistence.remove(mailing);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Mailing.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return mailingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return mailingPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return mailingPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return mailingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return mailingPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Mailing fetchMailing(long mailingId) throws SystemException {
		return mailingPersistence.fetchByPrimaryKey(mailingId);
	}
	...
	public Mailing getMailing(long mailingId)
		throws PortalException, SystemException {
		return mailingPersistence.findByPrimaryKey(mailingId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return mailingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Mailing> getMailings(int start, int end)
		throws SystemException {
		return mailingPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getMailingsCount() throws SystemException {
		return mailingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Mailing updateMailing(Mailing mailing) throws SystemException {
		return mailingPersistence.update(mailing);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("net.zylk.liferay.portal.model.Mailing",
			mailingLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = mailingPersistence.getDataSource();
	...
	private MailingLocalServiceClpInvoker _clpInvoker = new MailingLocalServiceClpInvoker();
}