...
import net.zylk.liferay.portal.service.MailingLangLocalService;
...
/**
 * Provides the base implementation for the mailing lang local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.zylk.liferay.portal.service.impl.MailingLangLocalServiceImpl}.
 * </p>
 *
 * @author zylk.net
 * @see net.zylk.liferay.portal.service.impl.MailingLangLocalServiceImpl
 * @see net.zylk.liferay.portal.service.MailingLangLocalServiceUtil
 * @generated
 */
public abstract class MailingLangLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MailingLangLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.zylk.liferay.portal.service.MailingLangLocalServiceUtil} to access the mailing lang local service.
	 */
	...
	@Override
	public MailingLang addMailingLang(MailingLang mailingLang)
		throws SystemException {
		mailingLang.setNew(true);

		return mailingLangPersistence.update(mailingLang);
	}
	 ...
	 */
	@Override
	public MailingLang createMailingLang(long mailingLangId) {
		return mailingLangPersistence.create(mailingLangId);
	}
	...
	@Override
	public MailingLang deleteMailingLang(long mailingLangId)
		throws PortalException, SystemException {
		return mailingLangPersistence.remove(mailingLangId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MailingLang deleteMailingLang(MailingLang mailingLang)
		throws SystemException {
		return mailingLangPersistence.remove(mailingLang);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MailingLang.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return mailingLangPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return mailingLangPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return mailingLangPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MailingLang fetchMailingLang(long mailingLangId)
		throws SystemException {
		return mailingLangPersistence.fetchByPrimaryKey(mailingLangId);
	}
	 ...
	 */
	@Override
	public MailingLang getMailingLang(long mailingLangId)
		throws PortalException, SystemException {
		return mailingLangPersistence.findByPrimaryKey(mailingLangId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return mailingLangPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MailingLang> getMailingLangs(int start, int end)
		throws SystemException {
		return mailingLangPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getMailingLangsCount() throws SystemException {
		return mailingLangPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MailingLang updateMailingLang(MailingLang mailingLang)
		throws SystemException {
		return mailingLangPersistence.update(mailingLang);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("net.zylk.liferay.portal.model.MailingLang",
			mailingLangLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = mailingLangPersistence.getDataSource();
	...
	private MailingLangLocalServiceClpInvoker _clpInvoker = new MailingLangLocalServiceClpInvoker();
}