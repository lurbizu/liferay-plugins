...
<liferay-ui:search-container emptyResultsMessage="zn.general.list.empty">
	...
	<liferay-ui:search-container-row
		...
		<liferay-ui:search-container-column-text name="name" value="<%= subscriptor.getName() %>" align="left" />
		<liferay-ui:search-container-column-text name="zn.general.surname" value="<%= subscriptor.getSurname() %>" align="left" />
		<liferay-ui:search-container-column-text name="email" value="<%= subscriptor.getEmail() %>" align="left" />
