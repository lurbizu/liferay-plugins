...
<liferay-ui:search-container emptyResultsMessage="zn.general.list.empty">
	...
	<liferay-ui:search-container-row
		...
		<liferay-ui:search-container-column-text name="email" value="<%= mailingSubscriptor.getEmail() %>" align="left" />
		
		<liferay-ui:search-container-column-text name="name" value="<%= mailingSubscriptor.getName() %>" align="left" />
		
		<liferay-ui:search-container-column-text name="zn.general.surname" value="<%= mailingSubscriptor.getSurname() %>" align="left" />
