...
<aui:form action="<%= editSubscriptor.toString() %>" method="post" >
	...
	<aui:fieldset>		
		<aui:input name="name" type="text" size="75" value="<%= subscriptor.getName() %>" >
			<aui:validator name="maxLength">75</aui:validator>
		</aui:input>
		<aui:input name="surname" label="zn.general.surname" type="text" size="75" value="<%= subscriptor.getSurname() %>" >
			<aui:validator name="maxLength">75</aui:validator>
		</aui:input>
		<aui:input name="email" type="text" size="75" value="<%= subscriptor.getEmail() %>">
