AUI.add(
	...
	function(A) {
		...
		var TPL_UPLOAD = [
			'<div class="upload-target dropzone" id="{$ns}uploader">',
				'<div class="drag-drop-area dz-default dz-message" id="{$ns}uploaderContent">',
					'<tpl if="this.uploaderType == \'html5\'">',
						'<h4 class="drop-file-text"><span class="bigger-150 bolder"><i class="icon-caret-right red"></i>{[ this.dropFileText ]} </span><span class="or-text smaller-80 grey">{[ this.strings.orText ]}</span></h4>',
					'</tpl>',
