...
<aui:fieldset>
	...
	// Eurohelp Consulting//
	if (AssetPermission.contains(permissionChecker,scopeGroupId,ActionKeys.ADD_CATEGORY)) {%>
		<aui:input classPK="<%= classPK %>" name="categories" type="assetCategories" />
	<%}if (AssetPermission.contains(permissionChecker,scopeGroupId,ActionKeys.ADD_TAG)) {%>
