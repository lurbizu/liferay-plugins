		...
		<c:choose>
			<c:when test="<%= user2 == null %>">
				...
				<aui:input label="<%= loginLabel %>" name="<%= loginParameter %>" size="30" type="text" value="<%= loginValue %>">
					...
					<aui:validator name="custom" errorMessage="barne-erabiltzaileek-ezin-pasahitza-aldatu">
					function (val, fieldNode, ruleValue) {
						var suffix = 'gipuzkoa.net'; 
						var suffix2 = 'gipuzkoa.eus';
						return val.indexOf(suffix, val.length - suffix.length) == -1 && val.indexOf(suffix2, val.length - suffix2.length) == -1;
					}
					</aui:validator>
				</aui:input>
